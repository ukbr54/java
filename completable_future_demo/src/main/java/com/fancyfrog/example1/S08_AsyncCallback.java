...
public class S08_AsyncCallback extends AbstractFuturesTest {
    ...
    @Test
    public void whenThreadInvokesCallbacks() throws ExecutionException, InterruptedException {

        final CompletableFuture<String> java =
                CompletableFuture.supplyAsync(() -> client.mostRecentQuestionAbout("java"), poolAlpha);

        final CompletableFuture<String> scala =
                CompletableFuture.supplyAsync(() -> client.mostRecentQuestionAbout("scala"), poolBeta);
